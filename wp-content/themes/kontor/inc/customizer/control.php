...
class Kontor_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kontor-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Kontor_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Kontor_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Kontor_Note_Control extends WP_Customize_Control {
