...
( function( $, api ) {
	...
	api.controlConstructor['kontor-repeater-text'] = api.Control.extend({
	    ...
	    // upsell 
    api.sectionConstructor['kontor-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#kontor-img-container li label img').click(function(){    	
    //     $('#kontor-img-container li').each(function(){
    //         $(this).find('img').removeClass ('kontor-radio-img-selected') ;
    //     });
    //     $(this).addClass ('kontor-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', kontor_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', kontor_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', kontor_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #kontor-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #kontor-img-container li').each(function(){
            $(this).find('img').removeClass ('kontor-radio-img-selected') ;
        });
        $(this).addClass ('kontor-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #kontor-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #kontor-img-container li').each(function(){
            $(this).find('img').removeClass ('kontor-radio-img-selected') ;
        });
        $(this).addClass ('kontor-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #kontor-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #kontor-img-container li').each(function(){
            $(this).find('img').removeClass ('kontor-radio-img-selected') ;
        });
        $(this).addClass ('kontor-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #kontor-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #kontor-img-container li').each(function(){
            $(this).find('img').removeClass ('kontor-radio-img-selected') ;
        });
        $(this).addClass ('kontor-radio-img-selected') ;
    });    

    function kontor_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            kontor_customize_multi_write( $control );
    }

    function kontor_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        kontor_customize_multi_write( $control );
    }

    function kontor_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function kontor_customize_multi_write( $element) {
