...
== Description ==
Kontor is a multi-purpose WordPress theme with practically unlimited options for customization, making it an excellent choice for any business. It can be used to create any type of website like consultancy, finance, corporate, travel, education, medical. It is responsive, SEO friendly, speed optimized, and translation ready. Kontor is retina ready and fully responsive. Kontor theme has wide list of customizable features including front page customizable sections with customizer api and many more options. This theme comes with lots of features such as column layout options for front page sections.
== Installation ==
...
Kontor WordPress Theme, Copyright 2021 Sensational Theme
Kontor is distributed under the terms of the GNU General Public License v3 or Later
Link: http://www.sensationaltheme.com/downloads/kontor/
...
Screenshot Image
License: CC0 1.0 Universal (CC0 1.0)
https://purepng.com/photo/1078/people-red-haired-girl
...
* Woocommerce
	Woocommerce is recommended to use for create product for shop page and homepage.
...
= 1.2 - August 9, 2021 =
* Removed Comment code vaule.

= 1.1 - August 5, 2021 =
* Updated default vaule.
